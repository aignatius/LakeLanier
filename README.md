...
* Satellite datasets (e.g., Landsat, Sentinel-2)
...
* A Google Earth Engine account: [https://earthengine.google.com/](https://earthengine.google.com/)
* Basic familiarity with JavaScript and geospatial concepts
...
* Open satellite data providers (NASA, ESA, USGS)

## Disclaimer

This repository is for research and educational purposes only. Results may require validation with in-situ measurements for decision-making applications.
Disclaimer
